...
import { X, Play, Pause, RotateCcw, Volume2, BookOpen } from "lucide-react";
  ...
  (
    ...
    return (
      <div ref={ref} className="relative">
        ...
        {/* Arabic translation under the English line */}
        {arabicLine && (
          <p className="arabic_font text-base text-gray-700 mt-1 pr-1">
            {arabicLine}
          </p>
        )}
